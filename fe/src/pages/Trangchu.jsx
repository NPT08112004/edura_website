                ...
                {quickLinks.map((link) => (
                  <button 
                    ...
                    onClick={() => {
                      switch (link.action) {
                        case 'recent':
                          // Tài liệu vừa tải lên - lọc theo ngày gần đây (7 ngày)
                          window.location.href = '/home?uploadDate=last7days';
                          break;
                        
                        case 'exam-outline':
                          // Đề cương ôn thi cuối kì - tìm kiếm với từ khóa liên quan
                          window.location.href = '/home?search=' + encodeURIComponent('đề cương ôn thi');
                          break;
                        
                        case 'by-school':
                          // Tài liệu theo trường - điều hướng đến trang schools
                          window.location.href = '/schools';
                          break;
                        
                        case 'saved':
                          // Tài liệu đã lưu - yêu cầu đăng nhập
                          if (!isLoggedIn) {
                            Swal.fire({
                              icon: 'info',
                              title: 'Cần đăng nhập',
                              text: 'Vui lòng đăng nhập để xem tài liệu đã lưu',
                            ...
                            window.location.href = '/profile?tab=saved';
                          }
                          break;

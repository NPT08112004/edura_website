...
import { Upload, X, FileText, Image as ImageIcon, CheckCircle2, AlertCircle, Loader2, Home, ArrowLeft, LogIn } from 'lucide-react';
      ...
      <div className="upload-container">
        ...
        <div className="upload-header">
          <div className="header-content">
            ...
            <p className="header-subtitle">Chia sẻ tài liệu của bạn với cộng đồng</p>
          </div>
        </div>

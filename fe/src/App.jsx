...
export default function App() {
  ...
  return (
    <Routes>
      ...
      {/* Saved Documents - Redirect to profile tab */}
      <Route path="/saved" element={localStorage.getItem('edura_token') ? <Navigate to="/profile?tab=saved" replace /> : <Navigate to="/login" />} />
